...
#ifndef COAP_TRACE_CLIENT_H
#define COAP_TRACE_CLIENT_H
 ...
 * \class CoapTraceClient
 * \brief A trace based streamer
 *
 * Sends CoAP packets based on a trace file of an MPEG4 stream
 ...
 */
class CoapTraceClient : public Application
{
public:
  /**
   ...
   * \param port the destination Coap port to which the stream will be sent
   ...
   *
   */
  CoapTraceClient (Ipv4Address ip, uint16_t port, char *traceFile);
  ~CoapTraceClient ();
